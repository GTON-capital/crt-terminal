...
6. `typeCommand: (payload: string) => void` - prints command in terminal's command line. **Important!** typeCommand is async operation, so your next message will be printed as soon as the previous one is finished
